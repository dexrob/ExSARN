...
parser.add_argument("--p_threshold", default=0.2, type=int, help="error threshold for property classification")
...
# args.rand_seed = 66 # running 1 s 1->0
# args.w_p = 2 # running 8 0->1
# args.use_stiffness = 1
# args.use_roughness = 1
# args.dataset = 'c20comb'
# print(args)
# test_acc1, test_stiffness_acc1, test_roughness_acc1 = train(args)
result = []
args.sequence_length = 400
args.latent_length = 4
for w_p in [0.5]:
    args.w_p = w_p
    for ds in ['c20']: # , 'c20comb', 'c20new'
        args.dataset = ds
        for k in range(5):
            args.kfold = k
            args.use_stiffness = 1
