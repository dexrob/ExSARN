...
def main(args):
    ...
    mid_norm = None # "BN"
    model_name = "BT19_{}_ConcatPathway_stiffness{}_roughness{}_p_thre_{}_rs_{}_ll{}_ihs{}_ohs{}_rf{}_res{}_rec{}_mid{}o{}_ep{}_lr{}_wp_{}_wc{}_wr1{}_wr2{}_wkl{}_var{}_rep{}_k{}_p_{}".format(str(use_stiffness), str(use_roughness), str(p_threshold), str(args.rand_seed), data_folder[:-1], latent_length, receptor_hidden_size, mid_hidden_size, str(receptor_freq), residual, receptor_block, mid_block, mid_lmu_order, n_epochs, learning_rate, w_p, w_c, w_r1, w_r2, w_kl, var, rep, str(kfold_number), str(sample_percent))
    ...
    for wp in [1,2,5]:
        ...
        for (r,s) in [(1,0), (0,1), (1,1)]:
            ...
            if p == 0.3:
                ...
                i_ = [0,1,2]
            for i in i_: # k here serves as the random seed for generate train/val/test data
                args.i = i
                for k in range(5):
                    args.kfold = k
                    print(args)
